...
from nets.Mixconv import MSFEM1, MSFEM2
...
class CSPDarknet(nn.Module):
    def __init__(self, base_channels, base_depth, phi, pretrained):
        ...
        self.dark2 = nn.Sequential(
            ...
            # MSFEM1(base_channels * 2, base_channels * 2),
        )
        ...
        self.dark3 = nn.Sequential(
            ...
            # MSFEM1(base_channels * 4, base_channels * 4),
        )
        ...
        self.dark4 = nn.Sequential(
            ...
            # MSFEM2(base_channels * 8, base_channels * 8),
        )
        ...
        self.dark5 = nn.Sequential(
            ...
            # MSFEM2(base_channels * 16, base_channels * 16),
